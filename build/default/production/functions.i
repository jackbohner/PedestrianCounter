...
# 41 "./mcc_generated_files/system/../uart/uart1.h" 2
# 60 "./mcc_generated_files/system/../uart/uart1.h"
typedef union {
    struct {
        uint8_t perr : 1;
        uint8_t ferr : 1;
...
# 93 "./mcc_generated_files/system/../uart/uart1.h"
...
# 118 "./mcc_generated_files/system/../uart/uart1.h"
...
# 135 "./mcc_generated_files/system/../uart/uart1.h"
...
# 176 "./mcc_generated_files/system/../uart/uart1.h"
...
# 227 "./mcc_generated_files/system/../uart/uart1.h"
_Bool UART1_IsTxDone(void);
# 237 "./mcc_generated_files/system/../uart/uart1.h"
size_t UART1_ErrorGet(void);
# 247 "./mcc_generated_files/system/../uart/uart1.h"
...
# 39 "./mcc_generated_files/system/../uart/uart2.h"
# 1 "./mcc_generated_files/system/system.h" 1
# 40 "./mcc_generated_files/system/../uart/uart2.h" 2
# 58 "./mcc_generated_files/system/../uart/uart2.h"
typedef union {
    struct {
        uint8_t perr : 1;
        uint8_t ferr : 1;
...
# 75 "./mcc_generated_files/system/../uart/uart2.h"
void UART2_Initialize(void);
# 84 "./mcc_generated_files/system/../uart/uart2.h"
...
# 109 "./mcc_generated_files/system/../uart/uart2.h"
...
# 126 "./mcc_generated_files/system/../uart/uart2.h"
...
# 200 "./mcc_generated_files/system/../uart/uart2.h"
_Bool UART2_IsRxReady(void);
# 209 "./mcc_generated_files/system/../uart/uart2.h"
_Bool UART2_IsTxReady(void);
# 218 "./mcc_generated_files/system/../uart/uart2.h"
_Bool UART2_IsTxDone(void);
# 228 "./mcc_generated_files/system/../uart/uart2.h"
size_t UART2_ErrorGet(void);
# 238 "./mcc_generated_files/system/../uart/uart2.h"
uint8_t UART2_Read(void);
# 248 "./mcc_generated_files/system/../uart/uart2.h"
...
# 59 "./mcc_generated_files/system/../i2c_host/i2c1.h"
...
_Bool I2C1_WaitDone(void);

_Bool DS3231_ReadTime(void);
void DS3231_PrintTime(void);
_Bool DS3231_WriteRegister(uint8_t reg, uint8_t value);
uint8_t DS3231_ReadRegister(uint8_t reg);
_Bool DS3231_SetAlarm1(uint8_t alarmHour, uint8_t alarmMin, uint8_t alarmSec);
_Bool DS3231_ClearAlarmFlag(void);
void DS3231_PrintAlarmDebug(void);

void Init_RTC_Interrupt_RC5(void);
void Init_RTC_Pin_RC5(void);

_Bool RTC_UpdateTime(void);
_Bool RTC_TimeReached(uint8_t targetHour, uint8_t targetMin);
void RTC_SleepUntil(uint8_t wakeHour, uint8_t wakeMin, uint8_t wakeSec);
_Bool RTC_SetTime(uint8_t setHour, uint8_t setMin, uint8_t setSec);
...
void buttonTask(void)
{
    ...
    {
        A_flag = 0;
        _delay((unsigned long)((30)*(64000000U/4000.0)));
...
_Bool DS3231_ReadTime(void)
{
    ...
    if(!I2C1_WriteRead(0x68, &reg, 1, data, 3))
        return 0;
...
uint8_t DS3231_ReadRegister(uint8_t reg)
{
    ...
    if(!I2C1_WriteRead(0x68, &reg, 1, &value, 1))
        return 0xFF;
...
_Bool RTC_SetTime(uint8_t setHour, uint8_t setMin, uint8_t setSec)
{
    ...
    data[3] = dec_to_bcd(setHour);

    if(!I2C1_Write(0x68, data, 4))
        return 0;
