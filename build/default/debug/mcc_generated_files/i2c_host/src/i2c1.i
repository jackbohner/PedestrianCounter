...
# 59 "mcc_generated_files/i2c_host/src/../i2c1.h"
...
void I2C1_Tasks(void)
{
    ...
    else if (0U != PIR2bits.I2C1RXIF)
    {
        *i2c1Status.readPtr = I2C1RXB;
        i2c1Status.readPtr++;
    }
    else if (0U != PIR3bits.I2C1TXIF)
    {
